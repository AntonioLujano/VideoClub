...
class MasPopularesController extends Controller
{
    ...
    public function index(Request $request)
    {
            ...
            $espera = DB::select('select * FROM socios s,listaespera l,peliculas p,generos g,directores d WHERE s.id_socio=l.id_socio and l.id_pelicula=p.id_pelicula and p.id_genero=g.id_genero and p.id_director= d.id_director and  s.id_socio=1 ORDER by estado desc');
