            ...
            <nav id="sidebarMenu" class="col-2 d-md-block bg-info text-center sidebar collapse">
                <div class="sidebar-sticky pt-4">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a href="/Devoluciones" class="list-group-item list-group-item-action bg-info text-white border-0"><i class="fas fa-handshake"> Devoluciones</i></a>
                        </li>
                        <li class="nav-item">
                            <a href="/deudas" class="list-group-item list-group-item-action bg-info text-white border-0"><i class="fas fa-money-bill-wave"> Deudas</i></a>
                        </li>
                        <li class="nav-item">
